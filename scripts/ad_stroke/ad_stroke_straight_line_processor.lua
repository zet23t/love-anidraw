...
local ad_stroke_straight_line_processor = require "love-util.class" "ad_stroke_straight_line_processor"
ad_stroke_straight_line_processor.editables = {
    {key = "straightness"; type = "number_slider"; name="straightness"; min = -1; max = 1; step = 0.01; default = 0.5},
}
function ad_stroke_straight_line_processor:new()
    return self:create {
        straightness = 0.5,
    }
end

function ad_stroke_straight_line_processor:process(ad_stroke, input_data, output_data)
    local vel = 0
...
return ad_stroke_straight_line_processor